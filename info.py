...
API_ID = int(environ.get('API_ID', '16008660'))
API_HASH = environ.get('API_HASH', 'a40f901dbfdca8909907caabf840f606')
BOT_TOKEN = environ.get('BOT_TOKEN', '5606831970:AAGv02EO8OfvwtaMk9vCxGR1tfXDwL6f-Tw')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://1:1@cluster0.pzvz3.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Anurag")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anurag_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001501547872'))
